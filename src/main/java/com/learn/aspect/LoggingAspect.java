...
//    Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
    ...
    @Pointcut("execution(* com.learn.controller.ProjectController.*(..)) || execution(* com.learn.controller.TaskController.*(..))")
    ...
    public void afterProjectAndTaskControllerAdvice(JoinPoint joinPoint, Object results){
    ...
    public void afterProjectAndTaskControllerAdvice(JoinPoint joinPoint, Exception exception){
